...
function marketReportBlock(selectedLang = 'pt') {
  const labels = {
    pt: { eyebrow: 'Relatório mensal', title: 'Plantel brasileiro de poedeiras', text: 'Visualize o material de apoio com dados de alojamento, plantel nacional e evolução dos indicadores. O arquivo completo fica disponível para download logo abaixo.', button: 'Baixar relatório em PDF', iframe: 'Visualização do relatório mensal do plantel brasileiro de poedeiras' },
    en: { eyebrow: 'Monthly report', title: 'Brazilian laying hen flock', text: 'View the support material with placement, national flock and indicator evolution data. The full file is available for download below.', button: 'Download PDF report', iframe: 'Monthly report preview' },
